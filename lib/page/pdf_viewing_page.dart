...
class PdfViewingPage extends StatefulWidget {
  String pdfItem;
  String title;
  PdfViewingPage({this.pdfItem, this.title});

  @override
  _PdfViewingPage createState() => _PdfViewingPage(pdfItem: pdfItem, title: title);
}
...
class _PdfViewingPage extends State<PdfViewingPage> {
  ...
  _PdfViewingPage({this.pdfItem, this.title});
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Container(width: 328.0, child: Text('No more occurrences found. Would you like to continue to search from the beginning?')),
          actions: <Widget>[
            TextButton(
              onPressed: () {
                setState(() {
              ...
              child: Text(
                'YES',
                style: TextStyle(color: Color(0x00000000).withOpacity(0.87), fontFamily: 'Roboto', fontStyle: FontStyle.normal, fontWeight: FontWeight.w500, decoration: TextDecoration.none),
              ),
            ),
            TextButton(
              onPressed: () {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: <Widget>[
        ...
        Flexible(
          child: TextFormField(
            style: TextStyle(color: Color(0x00000000).withOpacity(0.87), fontSize: 16),
            ...
            onFieldSubmitted: (String value) async {
              _pdfTextSearchResult = await widget.controller.searchText(_editingController.text);
          ...
          child: Row(
            children: [
              Text(
                ...
                style: TextStyle(color: Color.fromRGBO(0, 0, 0, 0.54).withOpacity(0.87), fontSize: 16),
              ),
              Text(
                ' of ',
                style: TextStyle(color: Color.fromRGBO(0, 0, 0, 0.54).withOpacity(0.87), fontSize: 16),
              ...
              Material(
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    setState(() {
                      if (_pdfTextSearchResult.currentInstanceIndex == _pdfTextSearchResult.totalInstanceCount && _pdfTextSearchResult.currentInstanceIndex != 0 && _pdfTextSearchResult.totalInstanceCount != 0) {
