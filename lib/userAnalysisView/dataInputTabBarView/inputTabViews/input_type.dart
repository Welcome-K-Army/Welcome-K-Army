    ...
    return Container(
        ...
        child: Column(
          children: [
            ...
            Container(
              child: institutionStatus.getStatus() ? CustomDropDownButton(height: size.height / 10, width: width, dropdownValue: typeAcademyItems[0], items: typeAcademyItems) : Container(),
            ),
          ],
        ));
  }
