...
class InputSchoolGradesAndKSAT extends StatefulWidget {
  InputSchoolGradesAndKSAT();

  InputSchoolGradesAndKSATState createState() => InputSchoolGradesAndKSATState();
}

class InputSchoolGradesAndKSATState extends State<InputSchoolGradesAndKSAT> {
