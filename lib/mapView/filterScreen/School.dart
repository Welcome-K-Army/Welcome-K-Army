...
class School{
  ...
  School({String name,String address,String number,String web_address,String image,String pdfurl,String web_address_detail, int idx, LatLng latlng, Categories category, Types type, Ages age, Classes classes,int one,int two,int three,int four}){
    this.name = name;
