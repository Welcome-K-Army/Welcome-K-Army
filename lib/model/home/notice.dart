...
final List<Content> noticeList = [
  ...
  new Content(title: 'Hello', content: 'World', person: personList[2], imgList: publicImgList),
  new Content(title: 'Outtro', content: 'Good Bye', person: personList[3], imgList: publicImgList),
];
